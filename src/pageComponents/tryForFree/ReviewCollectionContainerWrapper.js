...
const ReviewCollectionContainerWrapper = ({ children }) => {
	return (
		<div
			...
			<img className="absolute -top-7 left-0 classyBackgroundImage" src={classyimage} alt="bg-image" />
			<img className="absolute bottom-0 right-0 classyBackgroundImage" src={classyimage} alt="bg-image" />
